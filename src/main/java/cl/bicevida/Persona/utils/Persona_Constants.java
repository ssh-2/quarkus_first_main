...
public class Persona_Constants {
    ...
    public static final int nombresRazonSocialMin = 2;
    ...
    public static final int apellido1Min = 2;
    ...
    public static final int apellido2Min = 2;
    ...
    public static final int emailMin = 5;
    ...
    public static final int usuarioCreacionMin = 1;
    ...
    public static final int fechaNacimientoMin = 1;
    public static final int fechaNacimientoMax = 10;
    public static final String fechaNacimientoSize = fechaNacimientoJson + DEBE_POSEER_MINIMO + fechaNacimientoMin + DEBE_POSEER_MAXIMO + fechaNacimientoMax;
    ...
    public static  final int usuarioActualizacionJsonMin = 1;
