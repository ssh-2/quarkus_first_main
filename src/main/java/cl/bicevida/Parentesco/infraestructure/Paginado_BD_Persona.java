...
import static cl.bicevida.Utils.Constants.DEFAULT_CANTIDAD_ELEMENTOS;
import static cl.bicevida.Utils.Constants.DEFAULT_PAGINA_ACTUAL;
...
public class Paginado_BD_Persona implements PuertoSalida_Paginado_Persona {
    ...
    public Paginado_BD_Persona(PanacheRepository_Persona repository, Mapper_Parentesco mapper, RutValidation rutValidation) {
