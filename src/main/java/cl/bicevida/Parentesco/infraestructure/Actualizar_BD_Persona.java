...
public class Actualizar_BD_Persona implements PuertoSalida_Actualizar_Persona {
    ...
    public Actualizar_BD_Persona(PanacheRepository_Persona repository, PanacheRepository_TipoPersona repositoryTipoPersona, Mapper_Parentesco mapper, RutValidation rutValidation) {
