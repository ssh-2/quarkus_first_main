...
@Setter
@NoArgsConstructor
public class Request_Update_DTO_Parentesco {
    ...
    @NotNull(message = usuarioActualizacionParentescoJsonMSG_REQUIRED)
    @Size(min = usuarioActualizacionParentescoJsonMin, max = usuarioActualizacionParentescoJsonMax, message = usuarioActualizacionParentescoJsonMsg)
    @Schema(required = true, implementation = String.class, example = "Jhon")
    @JsonbProperty(usuarioActualizacionParentescoJson)
